...
def get_columns():
    return [
        ...
        {"label": _("Total Sales"), "fieldname": "total_sales", "fieldtype": "Currency", "width": 160, "options": "currency"},
        {"label": _("Deposit Amount"), "fieldname": "deposit_amount_total", "fieldtype": "Currency", "width": 160, "options": "currency"},
        {"label": _("Outstanding Amount"), "fieldname": "outstanding_total", "fieldtype": "Currency", "width": 160, "options": "currency"},
        {"label": _("Count of Transactions"), "fieldname": "transaction_count", "fieldtype": "Int", "width": 180},
    ]
...
def get_chart(data):
    ...
    return {
        ...
        "type": "pie",   # ? Pie Chart ÈÏáÇð ãä Bar
